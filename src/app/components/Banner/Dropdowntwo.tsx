...
const Problem: ProblemType[] = [
  ...
  { name: 'Enhancing data security' },
  { name: 'Automating manual processes' },
  { name: 'Scaling business growth' },
  { name: 'Gaining data-driven insights' },
  { name: 'Modernizing legacy systems' },
  { name: 'Building a new digital product' },
  { name: 'Other (please specify)' },
]

const Dropdown = () => {
  const [selected, setSelected] = useState(Problem[0])

  return (
    <div className="w-full">
      <Listbox value={selected} onChange={setSelected}>
      <h3 className='text-lg text-lightgrey'>What are you trying to solve?</h3>
